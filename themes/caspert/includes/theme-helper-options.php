...
function caspert_get_responsive_row_class($per_row): string
{
...
function caspert_get_footer_sidebar_columns_count (): int
{
    return caspert_opt(FooterOptions::class)::get_footer_sidebar_columns_count() ?? 4;
}