...
add_action('wp_enqueue_scripts', 'caspert_register_front_end_woo');

function caspert_register_front_end_woo(): void
{
    ...
    if (is_product()) {
        wp_enqueue_style('woo-single', get_theme_file_uri('/includes/woocommerce/assets/css/woo-single.min.css'), array(), caspert_get_version_theme());
    }

    if ( is_cart() ) {
        wp_enqueue_style('woo-cart', get_theme_file_uri('/includes/woocommerce/assets/css/woo-cart.min.css'), array(), caspert_get_version_theme());
    }

    if ( is_checkout() ) {
        wp_enqueue_style('woo-checkout', get_theme_file_uri('/includes/woocommerce/assets/css/woo-checkout.min.css'), array(), caspert_get_version_theme());
    }
