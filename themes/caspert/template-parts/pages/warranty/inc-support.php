            ...
            <div class="row">
                <div class="col-md-6 col-xl-4">
                    <div class="iconBox wow fadeInUp">
                        <div class="iconBox__icon"><img src="assets/img/iconBox-1.png" alt=""></div>
                        ...
                        <div class="iconBox__btn">
                            <a href="lienhe.html" class="btn-link">LIÊN HỆ VỚI CHÚNG TÔI <span><i class="ex-arrow-circle-left"></i></span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="iconBox wow fadeInUp">
                        <div class="iconBox__icon"><img src="assets/img/iconBox-2.png" alt=""></div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="iconBox wow fadeInUp">
                        <div class="iconBox__icon"><img src="assets/img/iconBox-4.png" alt=""></div>
                        ...
                        <div class="iconBox__btn">
                            <a href="baohanh-list.html" class="btn-link">TRA CỨU NGAY <span><i class="ex-arrow-circle-left"></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
