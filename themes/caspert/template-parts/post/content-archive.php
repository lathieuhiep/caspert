...
// Get sidebar layout
$sidebar = caspert_opt(PostArchiveOptions::class)::get_sidebar_layout_archive() ?? THEME_SIDEBAR_POSITION_RIGHT;
$class_col_content = caspert_col_use_sidebar($sidebar, 'sidebar-main');

// Get per row classes
$per_row = caspert_opt(PostArchiveOptions::class)::get_archive_row_columns() ?? 3;
