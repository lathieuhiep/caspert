...
$show_related = caspert_opt(SinglePostOptions::class)::get_show_related_posts() ?? THEME_YES;
$term_ids  = wp_get_post_terms( get_the_ID(), 'category', array( 'fields' => 'ids' ) );

if ( $show_related == THEME_YES && !empty( $term_ids ) ):
	$limit = caspert_opt(SinglePostOptions::class)::get_related_count() ?? 3;
    ...
    ?>
        <div class="related-posts">
            <h3 class="related-posts__title">
                <?php esc_html_e('Bài viết liên quan', 'caspert'); ?>
            </h3>
